...
map global spacekak-toggles W ':add-highlighter window/ wrap -word -indent -marker ↪<ret>' -docstring 'enable line wrap'
map global spacekak-toggles <a-W> ':remove-highlighter window/wrap_-word_-indent_-marker_↪<ret>' -docstring 'disable line wrap'
